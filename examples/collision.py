...
def save_simulation_results(env, simulator, output_file="simulation_results.json"):
    results = {
        "protected_satellite": env.protected.name,
        "collision_probability": getattr(env.protected, "collision_probability", None),
        "fuel_usage": getattr(env.protected, "fuel_usage", None),
        "maneuvers": getattr(env.protected, "maneuvers", None),
        "collision_objects": [debris.name for debris in env.debris],
